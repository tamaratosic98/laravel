            ...
            <ul class="navbar-nav mr-auto">
              ...
              <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link" href="http://localhost:8080/laravel_domaci/laravel/public/home">Home
                ...
                @else
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="http://localhost:8080/laravel_domaci/laravel/public/home">
                                Home
                            </a>
                        </div>
                    </li>
